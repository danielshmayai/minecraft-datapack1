...
tellraw @a [{"text":"[ULM] ","color":"gold","bold":true},{"text":"Universal Logic Modifier loaded!","color":"yellow"},{"text":" Use ","color":"gray"},{"text":"/function custom_logic:config","color":"aqua","clickEvent":{"action":"suggest_command","value":"/function custom_logic:config"},"hoverEvent":{"action":"show_text","contents":"Click to open config"}},{"text":" to configure.","color":"gray"}]
